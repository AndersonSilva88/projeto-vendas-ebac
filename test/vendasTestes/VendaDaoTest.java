...
import main.aplicacao.dao.*;
import main.aplicacao.dao.generic.jdbc.ConnectionFactory;
...
public class VendaDaoTest {
    ...
    @Before
    public void init() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException, SQLException {
    ...
    public void salvarVendaMesmoCodigoExistente() throws TipoChaveNaoEncontradaException, DAOException, SQLException {
    ...
    private Produto cadastrarProduto(String codigo, BigDecimal valor) throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException, SQLException {
    ...
    private Cliente cadastrarCliente() throws TipoChaveNaoEncontradaException, DAOException, SQLException {
        Cliente cliente = new Cliente();
        cliente.setCpf(12312312312L);
        cliente.setRg(789546951455L);
