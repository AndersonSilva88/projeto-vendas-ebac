...
import main.aplicacao.exceptions.*;
...
public abstract class GenericDAO<T extends Persistence, E extends Serializable> implements IGenericDAO<T, E> {
    ...
    public void alterar(T entity) throws TipoChaveNaoEncontradaException, DAOException {
        ...
        try {
            ...
            setParametrosQueryAtualizao(stm, entity);
            int rowsAffected = stm.executeUpdate();
        } catch (SQLException e) {
    ...
    private void setValueByType(T entity, Method method, Class<?> classField, ResultSet rs, String fieldName) throws SQLException, InvocationTargetException, IllegalAccessException, TipoElementoNaoConhecidoException {
